...
LGUI_T(KC_ESC),   KC_A,    KC_S,    KC_H,    KC_T,    KC_G,                         KC_Y,    KC_N,    KC_E,    KC_O,    KC_I,  KC_ENT,
  ...
  //,-----------------------------------------------------.                    ,-----------------------------------------------------.
      _______,   KC_P9,   KC_P7,   KC_P5,   KC_P3, KC_PMNS,                      XXXXXXX,   KC_AT, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
      _______,   KC_P8,   KC_P6,   KC_P4,   KC_P2, KC_PPLS,                      KC_LEFT, KC_DOWN,   KC_UP,KC_RIGHT, KC_HASH, _______,
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
